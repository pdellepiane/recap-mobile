...
import { normalizeChallengesFromApi } from '@/src/features/home/data/eventChallengesMap';
import { seedEventChallengeQuizzesFromApi } from '@/src/features/home/data/eventChallengesQuizSeed';
import { mapEventDetailDataToDomain } from '@/src/features/home/data/eventDetailRemoteMap';
import {
  fetchMockEventDetailRemote,
  shouldMockEventDetailRemote,
} from '@/src/features/home/data/eventDetailRemoteMock';
import { mapRankingApiItemsToRows } from '@/src/features/home/data/eventRankingMap';
import { fetchMockEventRankingRemote } from '@/src/features/home/data/eventRankingRemoteMock';
import { getCachedHomeEvent } from '@/src/features/home/data/homeEventCache';
import { mapHomeEventApiItemToDomain } from '@/src/features/home/data/homeFeedMap';
import {
  MOCK_HOME_BANNERS,
...
} from '@/src/features/home/data/homeFeedMock';
...
export class EventRepository {
  ...
  /**
   * GET /api/events/:id/challenges (Bearer) or static mock challenges when
   * {@link shouldMockEventDetailRemote} is true.
   */
  async fetchEventChallenges(eventId: string): Promise<EventChallenge[]> {
    if (shouldMockEventDetailRemote()) {
      const list = getStaticFallbackChallenges(eventId);
      seedEventChallengeQuizzesFromApi([]);
      cacheEventChallengesFromRemote(eventId, list);
      return list;
    }
    try {
